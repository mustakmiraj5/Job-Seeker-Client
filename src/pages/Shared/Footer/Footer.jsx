  ...
  return (
    <footer className="bg-gray-300">
      <div className="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
          ...
          <Link to="/">
            <div>
              <div className="flex justify-center sm:justify-normal items-center">
                ...
                <h1 className="text-xl font-semibold text-[#474747]">
                  MyJobGator
                </h1>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 gap-8 border-t border-gray-100 pt-8 sm:grid-cols-2 lg:grid-cols-4 lg:pt-16 justify-items-center text-center md:text-left">
          <div>
