...
const ContactUs = () => {
  useTitle("Contact");
  return (
    <div className="bg-gray-500 text-gray-100 px-8 py-12 mb-16">
      <div className="text-center w-full text-4xl text-[#FFF] font-bold">
        My Job Gator
      </div>
      <div
        ...
        <div className="flex flex-col justify-between">
          <div>
            ...
            <div className="text-gray-700 mt-8">
              Hate forms? Send us an <span className="underline cursor-pointer">email</span> instead.
            </div>
          </div>
            ...
            <svg className="w-full" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
              ...
              <defs>
                ...
                <linearGradient id="a964f849-fa65-4178-8cc4-fb8fb10b3617" x1="462.91" y1="660.68" x2="462.91"
                  y2="559.69" xlinkHref="#eb6c86d6-45fa-49e0-9a60-1b0612516196" />
              </defs>
        ...
        <div className="">
          ...
          <div className="mt-8">
            ...
            <input className="w-full bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline" type="email" />
          </div>
          <div className="mt-8">
          ...
          <div className="mt-8">
            <button
              className="uppercase text-sm font-bold tracking-wide bg-indigo-600 text-gray-100 p-3 rounded-lg w-full focus:outline-none focus:shadow-outline hover:bg-indigo-500">
              Send Message
            </button>
          </div>
        </div>
